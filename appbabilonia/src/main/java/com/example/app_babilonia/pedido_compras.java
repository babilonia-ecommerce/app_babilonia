...
public class pedido_compras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_compras);

        // Asignar Variable
        drawerLayout = findViewById(R.id.drawer_layout);
        // Definimos el titulo
        tv_titulo_activity = (TextView) findViewById(R.id.titulo_activity);
        String titulo = getResources().getString(R.string.menu_pedido_compras).toString();
        tv_titulo_activity.setText(titulo);

        // Definimos el usuario
        tv_usuario = (TextView)findViewById(R.id.nav_usuario);
        tv_id_empleado = (TextView) findViewById(R.id.pedido_compras_txt_id_empleado);
        tv_usuario = (TextView) findViewById(R.id.pedido_compras_txt_empleado);
        ...
        //tv_nombre_empleado.setText(preferences.getString("nombre_apellido", "hola"));
...
//      et_empleado.setText(nombre_empleado);
        ...
        et_id = (EditText) findViewById(R.id.txt_id_pedido_compras);
        et_id_proveedor = (EditText) findViewById(R.id.pedido_compras_txt_id_proveedor);
        et_observacion = (EditText) findViewById(R.id.pedido_compras_txt_observacion);
        et_fecha = (EditText) findViewById(R.id.pedido_compras_txt_fecha);
        ...
        bt_nuevo = (Button) findViewById(R.id.pedido_compras_bt_nuevo);
        bt_listar = (Button) findViewById(R.id.pedido_compras_bt_listar);

        // Integracion de objetos / spinner
        sp_estado = (Spinner) findViewById(R.id.pedido_compras_sp_estado);
        sp_provedor = (Spinner) findViewById(R.id.pedido_compras_sp_proveedores);
...
/*    // Metodo registrar
    ...
    public void PaqueteBuscar(View view){
        ...
        if (!busqueda.isEmpty()){
            ...
            Intent intent = new Intent(this, list_pedido_compras.class);
    ...
    public void pedidoComprasListar(View view) {
        // Listamos los Pedidos de Compras registrados
        Intent intent = new Intent(this, list_pedido_compras.class);
        startActivity(intent);
    }
}