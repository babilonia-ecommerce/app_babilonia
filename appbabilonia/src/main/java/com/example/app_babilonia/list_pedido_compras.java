...
public class list_pedido_compras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.lv_pedido_compras.setVisibility(View.INVISIBLE);
    ...
    public void PedidoComprasListar() {
        ...
        if (rows.getCount() > 0) {
            ...
            while (rows.moveToNext()) {
                ...
                SimpleAdapter adapter = new SimpleAdapter(this, items, R.layout.list_pedido_compras, new String[] {"id","empleado","proveedor", "fecha", "estado","total"}, new int[]{R.id.tv_id_pedido_pc, R.id.tv_empleado_nombre_pc, R.id.tv_proveedor_razon_social_pc, R.id.tv_fecha_pc, R.id.tv_estado_pc, R.id.tv_total_pc});
