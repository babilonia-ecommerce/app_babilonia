...
public class pedido_compras_detalle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_calendario_entrada.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog date = new DatePickerDialog(pedido_compras_detalle.this, date_entrada,
        ...
        btn_calendario_salida.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DatePickerDialog date = new DatePickerDialog(pedido_compras_detalle.this, date_salida,
        ...
        builder.setPositiveButton("SI", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!paq_cod_str.isEmpty()){
                    ...
                    if(eliminar >= 1){
                        Toast.makeText(pedido_compras_detalle.this, "Registro Eliminado", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(pedido_compras_detalle.this, pedido_compras.class);
                        startActivity(intent);

                    }else{ // En caso de que el id no exista
                        Toast.makeText(pedido_compras_detalle.this, "¡El registro indicado no existe!", Toast.LENGTH_SHORT).show();
                    }
                }else{ // en caso de que no complete el campo indicado
                    Toast.makeText(pedido_compras_detalle.this, "¡Debe indicar un codigo!", Toast.LENGTH_SHORT).show();
                }
            }
        });
                        ...
                        if(entrada.moveToFirst()){
                            ...
                            if (fecha_final.getTime().compareTo(fecha_entrada) < 0){
                                ...
                                if (nuevo_precio.moveToFirst()) {
                                    ...
                                    int editar = db.update("paquete", datos, "paq_cod=" + paquete_codigo, null);
                                    if (editar >= 1) {
                                        Toast.makeText(pedido_compras_detalle.this, "Registro Actualizado", Toast.LENGTH_SHORT).show();
                                    } else { // En caso de que el id no exista
                                        Toast.makeText(pedido_compras_detalle.this, "¡El registro indicado no existe!", Toast.LENGTH_SHORT).show();
                                    }
                                }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(eliminar >= 1){
                    ...
                    if (nuevo_precio.moveToFirst()){
                        ...
                        Toast.makeText(pedido_compras_detalle.this, "Ha ocurrido un error. Contante con el administrador", Toast.LENGTH_SHORT).show();
                    }
                }else{ // En caso de que el id no exista
                    Toast.makeText(pedido_compras_detalle.this, "¡El registro indicado no existe!", Toast.LENGTH_SHORT).show();
                }
